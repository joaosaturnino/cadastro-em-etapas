...
<html lang="pt-br">
        ...
        <div class="content">
            <div class="box-search">
                ...
                <button onclick="searchData()" class="btn btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="113" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
            ...
            <a style="display: block; width: 200px; text-decoration: none;" href="teste.php?id_estab=<?php echo $id_estab?>">
                <div id="new">
                    ...
                    <tbody>
                        <?php
                            while($user_data = mysqli_fetch_array($result)){
                                ...
                                echo "<td>
                                    <a class='btn btn-sm btn-warning' href='atualizaprod3.php?id_prod=".$user_data['proId']."&id=".$id_estab."'>
    ...
    <script> //script do campo de busca e alert de congirmação de exclusao
