...
<body>
    ...
    <div id="new" class="btn btn-sm btn-success" >
    <svg xmlns='http://www.w3.org/2000/svg' width=16' height='16' fill='curretColor' class='bi bi-plus-circle' viewBox='0 0 16 16'>
        ...
        <?php
              echo '<a href="produto.php?id_estab='.$id_estab.'">Novo</a>'; ?>
    </div>
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_array($result)){
                        ...
                        echo "<td>".$user_data['proImagem']."</td>";
                        echo "<td>".$user_data['est_Id']."</td>";
                        // echo "<td>".$user_data['est_Id']."</td>";
                        echo "<td>
                            <a class='btn btn-sm btn-warning' href='atualizaprod2.php?id_prod=$user_data[proId]'>
                        ...
                        echo "<td>
                            <a class='btn btn-sm btn-danger' href='./acoes/delete.php?id_prod=$user_data[proId]'>
