...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="content">
            ...
            <a style="display: block; width: 200px; text-decoration: none;" href="cadprod.php?id_estab=<?php echo $id_estab?>">
                <div id="new">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            while($user_data = mysqli_fetch_array($result)){
                                ...
                                echo "<td>
                                    <a class='btn btn-sm btn-warning' href='atualizaprod.php?id_prod=".$user_data['proId']."&id=".$id_estab."'>
